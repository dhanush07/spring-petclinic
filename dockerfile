...
FROM soleng.jfrog.io/artifactory/dhanush-demo-remote/alpine:3.18.2 AS build_stage
...
FROM soleng.jfrog.io/artifactory/dhanush-demo-remote/alpine:3.18.2 AS runtime
